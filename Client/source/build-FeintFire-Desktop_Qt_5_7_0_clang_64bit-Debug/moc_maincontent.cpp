...
#include "../FeintFire/maincontent.h"
...
QT_MOC_LITERAL(1, 12, 9), // "initCards"
QT_MOC_LITERAL(2, 22, 9), // "ListView*"
QT_MOC_LITERAL(3, 32, 0) // ""

    },
    "MainContent\0initCards\0ListView*\0"
};
...
static const uint qt_meta_data_MainContent[] = {
 ...
 // slots: name, argc, parameters, tag, flags
       1,    1,   19,    3, 0x08 /* Private */,

 // slots: parameters
    0x80000000 | 2, QMetaType::QVariantList,    3,
...
void MainContent::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { ListView* _r = _t->initCards((*reinterpret_cast< QList<QVariant>(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< ListView**>(_a[0]) = _r; }  break;
        default: ;
        }
    }
}
