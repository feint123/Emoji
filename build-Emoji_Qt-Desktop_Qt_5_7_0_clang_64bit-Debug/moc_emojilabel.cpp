...
QT_MOC_LITERAL(3, 22, 23), // "currentEmojiTextChanged"
QT_MOC_LITERAL(4, 46, 10), // "EmojiText*"
QT_MOC_LITERAL(5, 57, 4), // "text"
QT_MOC_LITERAL(6, 62, 11), // "setFontSize"
QT_MOC_LITERAL(7, 74, 4), // "size"
QT_MOC_LITERAL(8, 79, 7), // "setFont"
QT_MOC_LITERAL(9, 87, 12), // "setEmojiText"
QT_MOC_LITERAL(10, 100, 9), // "placeText"
QT_MOC_LITERAL(11, 110, 7), // "placeId"
QT_MOC_LITERAL(12, 118, 3) // "ver"

    },
    "EmojiLabel\0editEmoji\0\0currentEmojiTextChanged\0"
    "EmojiText*\0text\0setFontSize\0size\0"
    "setFont\0setEmojiText\0placeText\0placeId\0"
    "ver"
};
...
void EmojiLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->currentEmojiTextChanged((*reinterpret_cast< EmojiText*(*)>(_a[1]))); break;
        case 2: _t->setFontSize((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->setFont((*reinterpret_cast< const QFont(*)>(_a[1]))); break;
        case 4: _t->setEmojiText((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 5: _t->placeText((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (EmojiLabel::*_t)(EmojiText * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&EmojiLabel::currentEmojiTextChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void EmojiLabel::currentEmojiTextChanged(EmojiText * _t1)
{
