...
#include "../Client/source/feint/widget/view/listview.h"
...
QT_MOC_LITERAL(1, 9, 15), // "selectItemIndex"
...
void ListView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ListView::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ListView::selectItemIndex)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ListView::staticMetaObject = {
    { &QScrollArea::staticMetaObject, qt_meta_stringdata_ListView.data,
...
// SIGNAL 0
void ListView::selectItemIndex(int _t1)
{
